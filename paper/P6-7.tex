...
the corresponding author. In this section we describe prior efforts to gather
...
are available at \veritasdata. MAGIC at \magicurl. The release of the H.E.S.S.
Galactic plane survey catalog and the first all-sky HAWC catalog is expected
soon. FITS and VOTABLE data for some blazars is available at \desylc, which is
an evolution of the data format and dataset described in \citet{lc}. There's
also 2WHSP (\whsp, \citet{whsp}), a very recent catalog of of HE and VHE
