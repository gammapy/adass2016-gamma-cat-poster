...
evolution of the data format and dataset described in \citet{lc}. HAWC
publications are listed at \hawcdata, as far as we know, no HAWC data in
machine-readable format is available for download.
